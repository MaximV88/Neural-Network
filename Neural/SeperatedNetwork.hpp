...
#ifndef SeperatedNetwork_hpp
#define SeperatedNetwork_hpp
#include "OperationalNetwork.hpp"
#include <memory>
NAMESPACE_NEURAL_BEGIN

class SeperatedNetwork : public OperationalNetwork {
public:
     ...
     */
    SeperatedNetwork(const std::string& serialized);
